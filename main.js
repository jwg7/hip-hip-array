...
for (let i = 0; i < positiveNumbers.length; i++) {
  ...
  // Challenge 7 Code
let newerArray = newArray.splice(0);
console.log(newArray) // i notice that splice modified the original array. The challenge doesn't say I'm not able to do this!
...
for (let i = 0; i < emptyArray.length; i++) {
  ...
  // Challenge 11 Code
  let coolStudents = students.slice(3, 10)
console.log(coolStudents)
for (let i = 0; i < coolStudents.length; i++) {
  console.log(coolStudents[i])
}
  ...
  // Challenge 12 Code
let badDinosaurs = dinosaurs.splice(4, 3)
console.log(badDinosaurs)
...
// console.logging new array
for (let i = 0; i < z.length; i++) {
  console.log(z[i])
}

// console.logging primary array
for (let i = 0; i < x.length; i++) {
  console.log(x[i])
}

// console.logging secondary array
